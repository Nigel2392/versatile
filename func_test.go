...
func TestNewFuncValid(t *testing.T) {
	...
	f := versatile.NewFunc(fn, reflect.TypeOf(""))
...
func TestNewFuncInvalidNonFunc(t *testing.T) {
	...
	versatile.NewFunc("not a func", reflect.TypeOf(""))
}
...
func TestNewFuncMismatchedReturnTypes(t *testing.T) {
	...
	fn := func() string { return "hello" }
	versatile.NewFunc(fn, reflect.TypeOf(123)) // mismatch
}

func TestReturnsSuccess(t *testing.T) {
	fn := func() int { return 42 }
	f := versatile.NewFunc(fn, reflect.TypeOf(0))
	f.Returns(reflect.TypeOf(0))
}

func TestReturnsMismatch(t *testing.T) {
	fn := func() float64 { return 42 }
	f := versatile.NewFunc(fn, reflect.TypeOf(float64(0)))
...
func TestBeforeExecFails(t *testing.T) {
	...
	var funcObj = versatile.NewFunc(fn, reflect.TypeOf(0))
...
func TestCallWithConvert(t *testing.T) {
	...
	f := versatile.NewFunc(fn, reflect.TypeOf(String("")))
	out := f.Call(int8(65))
	if out[0] != String("A") {
...
func TestCallAdheresTo(t *testing.T) {
	...
	f := versatile.NewFunc(fn, reflect.TypeOf(int(0)))
...
func TestCallFuncMismatchReturn(t *testing.T) {
	...
	fn := func() string { return "hello" }
	f := versatile.NewFunc(fn, reflect.TypeOf(int(0))) // mismatch
	f.Call()
}
