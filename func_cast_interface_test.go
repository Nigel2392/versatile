...
func TestCast_FuncBroadToFmtStringer(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(fmt.Stringer) string](src)
	mustNoErr(t, err)
...
func TestCast_Interface1_LoudSpeaker(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(LoudSpeaker) string](src)
	mustNoErr(t, err)
...
func TestCast_Interface2_LoudSpeaker_RuntimePanic(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(Speaker) string](src)
	mustNoErr(t, err)
...
func TestCast_Interface3_GetSetter(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(GetSetter) int](src)
	mustNoErr(t, err)
...
func TestCast_Interface4_DogToAnimal(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(Animal)](src)
	mustNoErr(t, err)
...
func TestCast_Interface5_AnyToRunner(t *testing.T) {
	src := func(a any) {}
	out, err := versatile.CastFunc[func(Runner)](src)
	mustNoErr(t, err)
	out(myRunner{})
}
...
func TestCast_Interface6_FlyerToAny(t *testing.T) {
	src := func(f Flyer) {}
	out, err := versatile.CastFunc[func(any)](src)
	mustNoErr(t, err)
...
func TestCast_Interface8_CloserReturnsError(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(any) error](src)
	mustNoErr(t, err)
...
func TestCast_Interface10_Transformer(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(any) string](src)
	mustNoErr(t, err)
