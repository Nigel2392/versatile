...
func TestCast_ExactMatch(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(int, string) error](src)
	mustNoErr(t, err)
	if out == nil {
...
func TestCast_InterfaceMatch(t *testing.T) {
	src := func(a int, b string) error { return nil }
	out, err := versatile.CastFunc[func(any, string) error](src)
	mustNoErr(t, err)
	if out == nil {
		t.Fatalf("expected non-nil function")
	}
...
func TestCast_InterfaceMatchAll(t *testing.T) {
	src := func(a int, b string) error { return nil }
	out, err := versatile.CastFunc[func(any, any) any](src)
	mustNoErr(t, err)
	if out == nil {
		t.Fatalf("expected non-nil function")
	}
...
func TestCast_ConvertibleNumericArgs(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(int, int) float64](src)
	mustNoErr(t, err)
...
func TestCast_VariadicSource_ToFixedTarget(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(int, int) (bool, error)](src)
	mustNoErr(t, err)
	ok, e := out(3, 3)
	if e != nil {
...
func TestCast_FixedSource_ToVariadicTarget_ExactArity1(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(...any) (bool, error)](src)
	mustNoErr(t, err)
	ok, e := out(4, 4)
	if e != nil {
		t.Fatalf("unexpected error: %v", e)
...
func TestCast_FixedSource_ToVariadicTarget_ExactArity2(t *testing.T) {
	src := func(a, b int) (bool, error) { return a == b, nil }
	out, err := versatile.CastFunc[func(int, ...any) (bool, error)](src)
	mustNoErr(t, err)
	ok, e := out(4, 4)
	if e != nil {
		t.Fatalf("unexpected error: %v", e)
...
func TestCast_InterfaceReturn(t *testing.T) {
	...
	out, err := versatile.CastFunc[func() io.Writer](src)
	mustNoErr(t, err)
	w := out()
	if w == nil {
...
func TestCast_InterfaceParam(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(*bytes.Buffer) error](src)
	mustNoErr(t, err)
	var b bytes.Buffer
	if e := out(&b); e != nil {
		t.Fatalf("unexpected error: %v", e)
...
func TestCast_ConvertibleReturn(t *testing.T) {
	...
	out, err := versatile.CastFunc[func() int64](src)
	mustNoErr(t, err)
	if v := out(); v != 42 {
...
// ---versatile. Error Cases (creation time) ---

func TestCast_ArgCountMismatch(t *testing.T) {
	src := func(a int) error { return nil }
	_, err := versatile.CastFunc[func(int, int) error](src)
...
func TestCast_NotFunc_Source(t *testing.T) {
	...
	_, err := versatile.RCastFunc(outType, notFn)
	mustIsErr(t, err, versatile.ErrNotFunc)
}

func TestCast_NotFunc_Target(t *testing.T) {
	src := func() {}
	_, err := versatile.RCastFunc(reflect.TypeOf(123), src)
	mustIsErr(t, err, versatile.ErrNotFunc)
}
...
func TestCast_NilFunction(t *testing.T) {
	var fn any = nil
	outType := reflect.TypeOf(func() {})
	_, err := versatile.RCastFunc(outType, fn)
	mustIsErr(t, err, versatile.ErrNotFunc)
}
...
func TestCast_RuntimePanic_OnUnconvertibleArg_IntToString(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(int) int](src)
	mustNoErr(t, err)
	mustPanic(t, func() {
...
func TestCast_RuntimePanic_TooManyArgsForFixedSource(t *testing.T) {
	...
	_, err := versatile.CastFunc[func(int, int, int) int](src) // Allowed because destination considered variadic? No; both non-variadic -> should error
	if err == nil {
...
func TestCast_VariadicSource_ExtraArgs(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(int, int, int) int](src)
	mustNoErr(t, err)
...
func TestCast_DirectConvertibleFunctionType(t *testing.T) {
	...
	out, err := versatile.CastFunc[myAdder](src)
	mustNoErr(t, err)
	if out(2, 3) != 5 {
		t.Fatalf("expected 5")
	}
...
func TestCast_MultipleReturnConvertible(t *testing.T) {
	...
	out, err := versatile.CastFunc[func() (int64, float64)](src)
	mustNoErr(t, err)
	i, f := out()
	if i != 10 || f != 2.5 {
...
func TestCast_ReturnInterfaceWidening(t *testing.T) {
	...
	out, err := versatile.CastFunc[func() stringer](src)
	mustNoErr(t, err)
	s := out()
	if s.String() != "abc" {
...
func TestCast_NoReturn_VariadicForward(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(int, string)](src)
	mustNoErr(t, err)
	out(10, "x")
}
...
func TestCast_FixedSource_ToVariadicTarget_UnwrapInterfaceArgs(t *testing.T) {
	src := func(a, b int) int { return a + b }
	out, err := versatile.CastFunc[func(...any) int](src)
	mustNoErr(t, err)
...
func TestNonVariadicToVariadicArgs(t *testing.T) {
	...
	f, err := versatile.CastFunc[func(string, []byte, uint, uint, uint) (string, int, error)](fn)
	mustNoErr(t, err)
...
func TestStringToByteReturn(t *testing.T) {
	...
	f, err := versatile.CastFunc[func(string, int, int, int) ([]byte, int, error)](fn, versatile.WithFuncArgs("hello "))
	mustNoErr(t, err)
	s, l, e := f("world", 1, 2, 3)
	mustNoErr(t, e)
...
func TestCast_DiscardExtraReturns_ToErrorOnly(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(string, int) error](src)
	mustNoErr(t, err)
...
func TestCast_DiscardExtraParams_Wrapped(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(string, int) (string, int, error)](src, versatile.WithFuncArgs("a", "b", float64(100)))
	mustNoErr(t, err)
...
func TestCast_AnyReturns(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(string) any](src)
	mustNoErr(t, err)
...
func TestCast_AnyErrorReturns(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(string) (any, error)](src)
	mustNoErr(t, err)
...
func TestCast_AnyListReturns(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(string, int) any](src)
	mustNoErr(t, err)
...
func TestCast_AnyListErrorReturns(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(string, int) (any, error)](src)
	mustNoErr(t, err)
...
func TestWrapWithContext(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(int) int](src, versatile.WithFuncArgs(context.Background()))
	mustNoErr(t, err)
...
func TestWrapWithContextArg(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(ctx context.Context, a int) int](src, versatile.WithFuncArgs(context.Background()))
	mustNoErr(t, err)
...
func TestWrapWithContextIntArgs(t *testing.T) {
	...
	out, err := versatile.CastFunc[func() int](src, versatile.WithFuncArgs(5, 10, 50, versatile.Arg[context.Context](nil)))
	mustNoErr(t, err)
...
func TestWrapWithContextIntArg(t *testing.T) {
	...
	out, err := versatile.CastFunc[func() int](src, versatile.WithFuncArgs(5), versatile.WithContext(nil))
	mustNoErr(t, err)
...
func TestWrapWithContextIntArg2(t *testing.T) {
	...
	out, err := versatile.CastFunc[func() int](src, versatile.WithContext(nil), versatile.WithFuncArgs(5))
	mustNoErr(t, err)
...
func TestWrapWithContextOnly(t *testing.T) {
	...
	out, err := versatile.CastFunc[func() int](src, versatile.WithFuncArgs(context.Background()))
	mustNoErr(t, err)
...
func TestWrapWithContextMethod(t *testing.T) {
	...
	out, err := versatile.Method[func() (int, int, error)](saver, "Save", versatile.WithFuncArgs(context.Background()))
	if err != nil {
...
func TestWrapWithContextMethod2(t *testing.T) {
	var saver IntSaver = &intSaver{value: 21}
	out, err := versatile.Method[func() error](saver, "Save", versatile.WithFuncArgs(context.Background()))
	if err != nil {
		t.Fatalf("expected to find method Save: %v", err)
	}
...
func TestWrapWithContextMethod3(t *testing.T) {
	var saver IntSaver = &intSaver{value: 21}
	out, err := versatile.Method[func() ([]any, error)](saver, "Save", versatile.WithFuncArgs(context.Background()))
	if err != nil {
		t.Fatalf("expected to find method Save: %v", err)
	}
...
func TestCast_InterfaceContravariance(t *testing.T) {
	...
	out, err := versatile.CastFunc[func(BroadStringer) string](src)
	mustNoErr(t, err)
...
func TestCast_SaveMethodsVariations(t *testing.T) {
	...
	t.Run("func() error", func(t *testing.T) {
		m := &Model1{}
		saveFn, err := versatile.Method[func() error](m, "Save", versatile.WithContext(ctx))
		mustNoErr(t, err)
		mustNoErr(t, saveFn())
	})
...
func TestCast_SaveMethodsVariationsWrapArgs(t *testing.T) {
	...
	t.Run("func() error", func(t *testing.T) {
		m := &Model1{}
		saveFn, err := versatile.Method[func() error](m, "Save", versatile.WithFuncArgs(ctx))
		mustNoErr(t, err)
		mustNoErr(t, saveFn())
	})
	...
	t.Run("func(ctx context.Context) (..., error) 0 val", func(t *testing.T) {
		m := &Model3{}
		saveFn, err := versatile.Method[func()](m, "Save", versatile.WithFuncArgs(ctx))
		mustNoErr(t, err)
		saveFn()
	})
